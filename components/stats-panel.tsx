    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <Card className="bg-card border-2 border-violet-500/30 shadow-lg hover:shadow-violet-500/30 transition-all duration-300 hover:scale-[1.02] group">
        <CardHeader className="p-4 pb-2">
          <CardTitle className="text-xs font-semibold text-violet-600 dark:text-violet-400 uppercase tracking-wider flex items-center gap-2">
      ...
      <Card className="bg-card border-2 border-cyan-500/30 shadow-lg hover:shadow-cyan-500/30 transition-all duration-300 hover:scale-[1.02] group">
        <CardHeader className="p-4 pb-2">
          <CardTitle className="text-xs font-semibold text-cyan-600 dark:text-cyan-400 uppercase tracking-wider flex items-center gap-2">
      ...
      <Card className="col-span-2 bg-card border-2 border-[var(--red-team)]/40 shadow-lg hover:shadow-[var(--red-team)]/30 transition-all duration-300 hover:scale-[1.02] relative overflow-hidden group">
        ...
        <CardContent className="p-4 pt-0 relative z-10">
          <div className="flex justify-between items-baseline">
            <div className="text-4xl font-bold text-foreground group-hover:scale-110 transition-transform">{stats.modelAWins}</div>
            <div className="text-sm font-bold text-[var(--red-team)] bg-[var(--red-team)]/15 px-3 py-1.5 rounded-full border border-[var(--red-team)]/30 shadow-sm">
              {winRate}%
            </div>
          </div>
        </CardContent>
      ...
      <Card className="col-span-2 bg-card border-2 border-[var(--blue-team)]/40 shadow-lg hover:shadow-[var(--blue-team)]/30 transition-all duration-300 hover:scale-[1.02] relative overflow-hidden group">
        ...
        <CardContent className="p-4 pt-0 relative z-10">
          <div className="flex justify-between items-baseline">
            <div className="text-4xl font-bold text-foreground group-hover:scale-110 transition-transform">{stats.modelBWins}</div>
            <div className="text-sm font-bold text-[var(--blue-team)] bg-[var(--blue-team)]/15 px-3 py-1.5 rounded-full border border-[var(--blue-team)]/30 shadow-sm">
